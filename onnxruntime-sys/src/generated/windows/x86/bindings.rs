...
pub struct OrtApi {
    ...
    >,
    pub ReleaseOpAttr: ::std::option::Option<unsafe extern "stdcall" fn(input: *mut OrtOpAttr)>,
    ...
    >,
    pub ReleaseOp: ::std::option::Option<unsafe extern "stdcall" fn(input: *mut OrtOp)>,
